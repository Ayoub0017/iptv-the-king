...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    whyChoose: [
      ...
      {
        title: "Better Value Than 3 Months",
        description: "At £8.17/month you pay less per month than the 3-month plan, and unlock 4K streaming and 7-day Catch-Up TV.",
      },
      {
    ...
    planFaqs: [
      {
        ...
        answer: "The 6-month subscription includes 4K Ultra HD quality and 7-day Catch-Up TV, plus a lower monthly rate of £8.17/month versus £9.67/month for the 3-month plan. More features for less.",
      },
      {
    ...
    whyChoose: [
      {
        ...
        description: "At just £6.58/month, this is our most popular plan. Save over 30% per month compared to the 3-month plan while enjoying a full premium service all year round.",
      },
      {
    ...
    planFaqs: [
      {
        ...
        answer: "The 12-month subscription offers the best balance of price and features: at £6.58/month, it includes 4K, 14-day Catch-Up TV, PPV events and priority support. It is the preferred plan for customers who want a full year without worrying about renewal.",
      },
      {
